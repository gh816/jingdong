...
const useCartEffect = (shopId) => {
  ...
  return { total, price, productList, changeCartItemChecked, cleanCartProducts, allChecked, setCartItemsChecked, changeCartItemInfo }
}
...
export default {
  ...
  setup () {
    ...
    const {
      total, price, productList, changeCartItemChecked, cleanCartProducts,
      allChecked, setCartItemsChecked, changeCartItemInfo
...
.check{
  ...
  &__icon {
    ...
    &__tag{
      ...
      height: .2rem;
      line-height: .2rem;
      background-color: $hight-light-fontColor;
      border-radius: .1rem;
      font-size: .12rem;
      text-align: center;
      color: $bgColor;
