<template>
  <div class="wrapper">
    <div class="title">
      ...
      <div class="title__save" @click="upsetAddress">保存</div>
    </div>
    <div class="form">
...
export default {
  ...
  setup () {
    ...
    const { upsetAddress, formData } = useFormEffect(addressId)
    return { handleBackClick, upsetAddress, formData, addressList, addressId }
  }
}
</script>
